            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <tr>
                        <td>الوصف</td>
                        <td>
                            <textarea name="description_ar" class="form-control" id="content2"><?php if(isset($about->description)){echo $about->description;} ?></textarea>
                    ...
                    <tr>
                        <td>description</td>
                        <td>
                            <textarea name="description_en" class="form-control" id="content2"><?php if(isset($about->description)){echo $about->description;} ?></textarea>
                            @if ($errors->has('description'))
                            <span class=" alert alert-danger">
                                <strong>{{ $errors->first('description') }}</strong>
                            </span>
                    ...
                    <tr>
                        <td>السياسات</td>
                        <td>
                            <textarea name="policy_ar" class="form-control" id="content2"><?php if(isset($about->policy)){echo $about->policy;} ?></textarea>
                    ...
                    <tr>
                        <td>policy</td>
                        <td>
                            <textarea name="policy_en" class="form-control" id="content2"><?php if(isset($about->policy)){echo $about->policy;} ?></textarea>
                            @if ($errors->has('policy'))
                            <span class="alert alert-danger">
                                <strong>{{ $errors->first('policy') }}</strong>
                            </span>
