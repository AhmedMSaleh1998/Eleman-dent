...
<div class="row">
    <div class="col-sm-12">
        <div class="main-title-00">
            ...
            @endif
            <h4 class="page-title">العناوين</h4>
        </div>
        ...
        <div class="card-box">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class=" main-btn-00">
                        <!-- Responsive modal -->
                        <a href="{{route('admin.address.create',$user_id)}}" class="btn btn-default waves-effect">اضافه عنوان +</a>
                    </div>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table data-toggle="table" data-search="true" data-show-columns="true" data-sort-name="id" data-page-list="[8, 16, 32]" data-page-size="8" data-pagination="true" data-show-pagination-switch="true" class="table-bordered ">
                    ...
                    <thead>
                        <tr>
                            <th data-field="اسم المنطقة" data-align="center">اسم المنطقة</th>
                            <th data-field="الشارع" data-align="center">الشارع</th>
                            <th data-field="وقت الإنشاء" data-align="center">وقت الإنشاء</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$address->district->name_ar}}</td>
                        ...
                        <div id="{{$address->id}}delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog" style="width:55%;">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer" style="text-align:center">
                                        <form action="{{ route('admin.address.destroy',$address->id) }}" method="POST">
                                            {{csrf_field()}}
