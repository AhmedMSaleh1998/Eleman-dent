...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <h4 class="header-title m-t-0 m-b-20" style="text-align:center;">إضافة بانر جديد</h4>
                        ...
                        <div class="ff-grid">
                            <div class="ff-field">
                                ...
                                <input type="text" class="ff-input" name="alt_ar" required
                                    value="{{ old('alt_ar') }}" placeholder="وصف قصير لصورة البانر (مهم للـ SEO)">
                            ...
                            <div class="ff-field ff-field--full">
                                ...
                                <input type="text" class="ff-input" name="url" required dir="ltr"
                                    value="{{ old('url') }}" placeholder="الرابط الذي سينتقل إليه الزائر عند الضغط على البانر">
                                @if ($errors->has('url'))
