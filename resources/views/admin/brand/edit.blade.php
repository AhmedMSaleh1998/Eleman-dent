        ...
        <div class="col-12">
            <div class="card-box">
                <h4 class="header-title m-t-0 m-b-20" style="text-align:center;">
                    تعديل البرند: {{ optional($brand->translate('ar'))->name }}
                </h4>
                        ...
                        <div class="ff-grid">
                            <div class="ff-field ff-field--full">
                                ...
                                <img class="ff-current-img"
                                    src="{{ asset('admin_assets/images/brands/' . $brand->image) }}"
                        ...
                        <div class="ff-grid">
                            <div class="ff-field">
                                ...
                                <input type="text" class="ff-input" name="name_ar" required
                                    value="{{ old('name_ar', $brand->translate('ar')->name) }}">
                            ...
                            <div class="ff-field">
                                ...
                                <input type="text" class="ff-input" name="name_en" required dir="ltr"
                                    value="{{ old('name_en', $brand->translate('en')->name) }}">
                    ...
                    <div class="ff-card">
                        ...
                        <div class="ff-grid">
                            <div class="ff-field ff-field--full">
                                ...
                                <textarea class="ff-input" name="description_ar" rows="3" required>{{ old('description_ar', $brand->translate('ar')->description) }}</textarea>
                            ...
                            <div class="ff-field ff-field--full">
                                ...
                                <textarea class="ff-input" name="description_en" rows="3" required dir="ltr">{{ old('description_en', $brand->translate('en')->description) }}</textarea>
                        ...
                        <div class="ff-grid">
                            <div class="ff-field">
                                ...
                                <input type="text" class="ff-input" name="title_ar" required
                                    value="{{ old('title_ar', $brand->translate('ar')->title) }}">
                            ...
                            <div class="ff-field">
                                ...
                                <input type="text" class="ff-input" name="title_en" required dir="ltr"
                                    value="{{ old('title_en', $brand->translate('en')->title) }}">
                            ...
                            <div class="ff-field">
                                ...
                                <input type="text" class="ff-input" name="alt_ar" required
                                    value="{{ old('alt_ar', $brand->translate('ar')->alt) }}">
                            ...
                            <div class="ff-field">
                                ...
                                <input type="text" class="ff-input" name="alt_en" required dir="ltr"
                                    value="{{ old('alt_en', $brand->translate('en')->alt) }}">
                            ...
                            <div class="ff-field">
                                ...
                                <input type="text" class="ff-input" name="description_meta_ar" required
                                    value="{{ old('description_meta_ar', $brand->translate('ar')->description_meta) }}">
                            ...
                            <div class="ff-field">
                                ...
                                <input type="text" class="ff-input" name="description_meta_en" required dir="ltr"
                                    value="{{ old('description_meta_en', $brand->translate('en')->description_meta) }}">
                            ...
                            <div class="ff-field">
                                ...
                                <input type="text" class="ff-input" name="keywords_ar" required
                                    value="{{ old('keywords_ar', $brand->translate('ar')->keywords) }}">
                            ...
                            <div class="ff-field">
                                ...
                                <input type="text" class="ff-input" name="keywords_en" required dir="ltr"
                                    value="{{ old('keywords_en', $brand->translate('en')->keywords) }}">
                            ...
                            <div class="ff-field">
                                ...
                                <input type="text" class="ff-input" name="keywords_meta_ar" required
                                    value="{{ old('keywords_meta_ar', $brand->translate('ar')->keywords_meta) }}">
                            ...
                            <div class="ff-field">
                                ...
                                <input type="text" class="ff-input" name="keywords_meta_en" required dir="ltr"
                                    value="{{ old('keywords_meta_en', $brand->translate('en')->keywords_meta) }}">
