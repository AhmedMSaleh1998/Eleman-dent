                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class=" main-btn-00">
                            <!-- Responsive modal -->
                            <a href="{{ route('admin.category.create') }}" class="btn btn-default waves-effect">Add Category
                                +</a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="actions">
                                            <a href="{{ route('admin.changeStatus', [$category->status, 'categories', $category->id]) }}"
                                                ...
                                                title="Status"> {{ $category->status == 1 ? 'Hide' : 'Show' }}</a>
                                            ...
                                            <button type="button" class="btn btn-danger waves-effect" data-toggle="modal"
                                                data-target="#{{ $category->id }}delete" title="Delete">Delete </button>
                                        </td>
                                    </tr>
