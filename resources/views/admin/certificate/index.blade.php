                        ...
                        <tbody>
                            @if (isset($certificates))
                                @foreach ($certificates as $certificate)
                                    <tr>
                                        <td><img src="{{ asset('admin_assets/images/certificates/' . $certificate->image) }}"
                                    ...
                                    <div id="{{ $certificate->id }}delete" class="modal fade" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" style="width:55%;">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer" style="text-align:center">
                                                    <form
                                                        action="{{ action('App\Http\Controllers\Admin\CertificateController@destroy', $certificate['id']) }}"
                                                        method="post">
                                                        {{ csrf_field() }}
