...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="header-title m-t-0 m-b-20">اضافه لون</h4>

            <table class="table table-bordered table-striped">
                {{Form::open(['method'=>'POST','action' => ['App\Http\Controllers\Admin\ColorController@store'], 'files' => true])}}
                @csrf
                <tbody>
                    <tr>
                        <td>اسم عربي</td>
                    ...
                    <tr>
                        <td>الكود</td>
                        <td><input type="color" class="form-control" name="code" required></td>
                        @if ($errors->has('code'))
                        <span class="alert alert-danger">
