...
<div class="row">
    <div class="main-title-00">
        ...
        <a style="color: #fff;" href="{{ route('admin.course.index') }}">/ الكورسات / </a>
...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="header-title m-t-0 m-b-20">اضافه كورس</h4>

            <table class="table table-bordered table-striped">
                {{ Form::open(['method' => 'POST', 'action' => ['App\Http\Controllers\Admin\CourseController@store'] , 'files' => true]) }}
                <tbody>
                    <tr>
                        <td> Name Ar</td>
