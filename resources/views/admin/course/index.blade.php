...
<div class="row">
    <div class="col-sm-12">
        <div class="main-title-00">
            ...
            @endif
            <h4 class="page-title">الكورسات</h4>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class=" main-btn-00">
                        <!-- Responsive modal -->
                        <a href="{{ route('admin.course.create') }}" class="btn btn-default waves-effect">اضافه كورس +</a>
                    </div>
                </div>
            </div>
                ...
                <table data-toggle="table" data-search="true" data-show-columns="true" data-sort-name="id" data-page-list="[8, 16, 32]" data-page-size="8" data-pagination="true" data-show-pagination-switch="true" class="table-bordered ">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-field="الكود" data-align="center">وصف</th>
                            <th data-field="القيمة" data-align="center">صورة</th>
                    ...
                    <tbody>
                        ...
                        <div id="{{$course->id}}delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
