    ...
    <div class="col-lg-12">
        <div class="card-box">
            ...
            <div class="table-responsive">
                <table data-toggle="table" data-search="true" data-show-columns="true" data-sort-name="id" data-page-list="[8, 16, 32]" data-page-sole="8" data-pagination="true" data-show-pagination-switch="true" class="table-bordered ">
                    ...
                    <tbody>
                        @if(isset($delivertimes))
                        @foreach($delivertimes as $delivertime)
                        <tr>
                        ...
                        <div id="{{$delivertime->id}}delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog" style="width:55%;">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer" style="text-align:center">
                                        <form action="{{ route('admin.delivertime.destroy',$delivertime->id) }}" method="POST">
                                            {{csrf_field()}}
