...
<div class="row">
    <div class="main-title-00">
        ...
        <a style="color: #fff;" href="{{ route('admin.district.index') }}">/ منطقة / </a>
        ...
        <div class="card-box">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody> 
                    ...
                    <tr>
                        <td>مصاريف الشحن </td>
                        <td><input type="number" class="form-control" name="shipping_fees" required value="{{ old('shipping_fees') }}"></td>
