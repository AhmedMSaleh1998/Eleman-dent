            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class=" main-btn-00">
                        <!-- Responsive modal -->
                        <a href="{{ route('admin.district.create') }}" class="btn btn-default waves-effect">اضافه منطقة +</a>
                    </div>
                </div>
            </div>
                ...
                <table data-toggle="table" data-search="true" data-show-columns="true" data-sort-name="id" data-page-list="[8, 16, 32]" data-page-size="8" data-pagination="true" data-show-pagination-switch="true" class="table-bordered ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <a href="{{ route('admin.changeStatus',[$district->status,'districts',$district->id]) }}" class="btn btn-{{$district->status == 1 ? 'secondary' : 'dark'}} waves-effect" title="الحالة"> {{$district->status == 1 ? 'إبطال' : 'تفعيل'}}</a>
                                <a href="{{ route('admin.district.edit',$district->id) }}" class="btn btn-success waves-effect" title="تعديل">تعديل</a>
                                <button type="button" class="btn btn-danger waves-effect" data-toggle="modal" data-target="#{{$district->id}}delete" title="حذف">حذف </button>
                            </td>
                        </tr>
