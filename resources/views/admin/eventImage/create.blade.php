...
<div class="row">
    <div class="main-title-00">
        ...
        <a style="color: #fff;" href="{{ route('admin.eventimage.index',$event_id) }}">/ Event Images/ </a>
...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="header-title m-t-0 m-b-20"> Add Event Image</h4>
            {{ Form::open(['method'=>'POST','action' => ['App\Http\Controllers\Admin\EventImageController@store'], 'files' => true])}}
