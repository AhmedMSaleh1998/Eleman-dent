        ...
        <div class="col-12">
            <div class="card-box">
                <h4 class="header-title m-t-0 m-b-20" style="text-align:center;">
                    تعديل طريقة الدفع: {{ optional($paymentmethod->translate('ar'))->name }}
                </h4>
                        ...
                        <div class="ff-grid">
                            <div class="ff-field">
                                ...
                                <input type="text" class="ff-input" name="name_ar" required
                                    value="{{ old('name_ar', $paymentmethod->translate('ar')->name) }}">
                            ...
                            <div class="ff-field">
                                ...
                                <input type="text" class="ff-input" name="name_en" required dir="ltr"
                                    value="{{ old('name_en', $paymentmethod->translate('en')->name) }}">
