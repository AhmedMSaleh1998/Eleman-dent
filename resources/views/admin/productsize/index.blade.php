            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class=" main-btn-00">
                        <a href="{{ route('admin.productsize.create', $product_id) }}" class="btn btn-default waves-effect">اضافه
                            مقاس
                            للمنتج
                            +</a>
                    </div>
                ...
                <table data-toggle="table" data-search="true" data-show-columns="true" data-sort-name="id" data-page-list="[8, 16, 32]" data-page-size="8" data-pagination="true" data-show-pagination-switch="true" class="table-bordered ">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-field="السعر بعد الخصم" data-align="center">السعر بعد الخصم</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $productsize->name_ar }}</td>
                            <td>{{ $productsize->discount_price }}</td>
                            ...
                            <td class="actions">
                                ...
                                <a href="{{ route('admin.productsize.edit', $productsize->id) }}" class="btn btn-success waves-effect" title="تعديل">تعديل</a>
                            ...
                            <div class="modal-dialog" style="width:55%;">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer" style="text-align:center">
                                        <form action="{{ route('admin.productsize.destroy', $productsize->id) }}" method="post">
                                            @csrf
