...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <h4 class="header-title m-t-0 m-b-20" style="text-align:center;">إضافة رأي جديد</h4>

                <div class="ff-wrap">
                    <p class="ff-note">الحقول المعلمة بعلامة <span style="color:#e74c3c; font-weight:bold;">*</span>
                        إجبارية ولا يمكن الحفظ بدونها.</p>

                    {{ Form::open(['method' => 'POST', 'action' => ['App\Http\Controllers\Admin\CustomerReviewController@store'], 'files' => true]) }}
                    @csrf
                        ...
                        <div class="ff-grid">
                            <div class="ff-field ff-field--full">
                                ...
                                <input type="text" class="ff-input" name="name" required value="{{ old('name') }}"
                                    placeholder="اسم الطبيب كما سيظهر في الموقع">
                                @if ($errors->has('name'))
                            ...
                            <div class="ff-field ff-field--full">
                                ...
                                <textarea class="ff-input" name="review" rows="3" required
                                    placeholder="نص الرأي كما سيظهر في الموقع">{{ old('review') }}</textarea>
