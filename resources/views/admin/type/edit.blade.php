...
<div class="row">
    <div class="main-title-00">
        ...
        <a style="color: #fff;" href="{{ route('admin.type.index') }}">/ الانواع / </a>
...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="header-title m-t-0 m-b-20">تعديل نوع</h4>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <tr>
                        <td>اسم عربي</td>
                        <td><input type="text" class="form-control" name="name_ar" required value="{{ $type->name_ar }}"></td>
                    ...
                    <tr>
                        <td>اسم انجليزي</td>
                        <td><input type="text" class="form-control" name="name_en" required value="{{ $type->name_en }}"></td>
