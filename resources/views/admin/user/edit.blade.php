...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="header-title m-t-0 m-b-20">تعديل بيانات مستخدم</h4>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>الايميل</td>
                        <td><input type="email" class="form-control" name="email" required value="{{ $user->email }}"></td>
                        @if ($errors->has('email'))
                        <span class="alert alert-danger">
                    ...
                    <tr>
                        <td>الهاتف</td>
                        <td><input type="text" class="form-control" name="phone" required value="{{ $user->phone }}"></td>
                        @if ($errors->has('phone'))
                        <span class="alert alert-danger">
